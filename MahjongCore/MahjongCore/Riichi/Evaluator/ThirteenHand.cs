...
namespace MahjongCore.Riichi.Evaluator
{
    internal class ThirteenHand : CandidateHand
    {
        ...
        protected override void ExpandAndInsert(List<CandidateHand> chBucket, IHand baseHand) { chBucket.Add(this); }
        ...
        protected override bool Evaluate(IHand hand, bool ron)
        {
            ...
            ResetValues();
            Han += EvaluateYakuList(hand, ron, new Yaku[] { Riichi.Yaku.KokushiMusou,
